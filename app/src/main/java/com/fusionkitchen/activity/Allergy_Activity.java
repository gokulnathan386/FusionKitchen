...
public class Allergy_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*---------------------------check internet connection----------------------------------------------------*/
        int_chk = new Internet_connection_checking(Allergy_Activity.this);
        Connection = int_chk.checkInternetConnection();
        if (!Connection) {
            Allergy_Activity.ViewDialog alert = new Allergy_Activity.ViewDialog();
            alert.showDialog(Allergy_Activity.this);
        ...
        /*---------------------------Sql Lite DataBase----------------------------------------------------*/
        dbHelper = new SQLDBHelper(Allergy_Activity.this);
        getContactsCount();
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.home_card:
                        ...
                        if (cursor != 0) {
                            ...
                            Toast.makeText(Allergy_Activity.this,"Your cart is Empty",Toast.LENGTH_SHORT).show();
                        }
        ...
        traemWebView.loadUrl("https://www.fusionkitchen.co.uk/allergy");
    ...
    public class ViewDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            Window window = Allergy_Activity.this.getWindow();
            window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
            final AlertDialog.Builder builder = new AlertDialog.Builder(Allergy_Activity.this, R.style.CustomAlertDialog);
    ...
    public void loadingshow() {
        ...
        dialog = new Dialog(Allergy_Activity.this);
        ...
        */
        ...
        Glide.with(Allergy_Activity.this)
    ...
    public void onResume() {
        ...
        MyApplication.getInstance().trackScreenView("Allergy Activity");
    }
}
