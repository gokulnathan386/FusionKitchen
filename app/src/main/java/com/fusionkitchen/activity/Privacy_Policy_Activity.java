...
public class Privacy_Policy_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*---------------------------check internet connection----------------------------------------------------*/
        int_chk = new Internet_connection_checking(Privacy_Policy_Activity.this);
        Connection = int_chk.checkInternetConnection();
        if (!Connection) {
            Privacy_Policy_Activity.ViewDialog alert = new Privacy_Policy_Activity.ViewDialog();
            alert.showDialog(Privacy_Policy_Activity.this);
        ...
        /*---------------------------Sql Lite DataBase----------------------------------------------------*/
        dbHelper = new SQLDBHelper(Privacy_Policy_Activity.this);
        getContactsCount();
       ...
       /* bottomNav = findViewById(R.id.bottom_navigation);
        ...
        traemWebView.loadUrl("https://www.fusionkitchen.co.uk/privacy");
    ...
    public class ViewDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            Window window = Privacy_Policy_Activity.this.getWindow();
            window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
            final AlertDialog.Builder builder = new AlertDialog.Builder(Privacy_Policy_Activity.this, R.style.CustomAlertDialog);
    ...
    public void loadingshow() {
        ...
        dialog = new Dialog(Privacy_Policy_Activity.this);
        ...
        */
        ...
        Glide.with(Privacy_Policy_Activity.this)
    ...
    public void onResume() {
        ...
        MyApplication.getInstance().trackScreenView("Privacy Policy Activity");
    }
}
