...
public class Terms_Conditions_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*---------------------------check internet connection----------------------------------------------------*/
        int_chk = new Internet_connection_checking(Terms_Conditions_Activity.this);
        Connection = int_chk.checkInternetConnection();
        if (!Connection) {
            Terms_Conditions_Activity.ViewDialog alert = new Terms_Conditions_Activity.ViewDialog();
            alert.showDialog(Terms_Conditions_Activity.this);
        ...
        /*---------------------------Sql Lite DataBase----------------------------------------------------*/
        dbHelper = new SQLDBHelper(Terms_Conditions_Activity.this);
        getContactsCount();
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.home_card:
                        ...
                        if (cursor != 0) {
                            ...
                            Toast.makeText(Terms_Conditions_Activity.this,"Your cart is Empty!",Toast.LENGTH_SHORT).show();
                        }
    ...
    public class ViewDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            Window window = Terms_Conditions_Activity.this.getWindow();
            window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
            final AlertDialog.Builder builder = new AlertDialog.Builder(Terms_Conditions_Activity.this, R.style.CustomAlertDialog);
    ...
    public void loadingshow() {
        ...
        dialog = new Dialog(Terms_Conditions_Activity.this);
        ...
        */
        ...
        Glide.with(Terms_Conditions_Activity.this)
    ...
    public void onResume() {
        ...
        MyApplication.getInstance().trackScreenView("Terms Activity");
    }
}
