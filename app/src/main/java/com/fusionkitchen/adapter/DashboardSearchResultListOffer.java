...
public class  DashboardSearchResultListOffer<sharedpreferences> extends RecyclerView.Adapter< DashboardSearchResultListOffer.ViewHolder> {
    ...
    public  DashboardSearchResultListOffer(Context mContext, List<location_type_sub_modal.clients> listdata) {
    ...
    @Override
    public  DashboardSearchResultListOffer.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.raw_dashboard_search_details, parent, false);
        DashboardSearchResultListOffer.ViewHolder viewHolder = new  DashboardSearchResultListOffer.ViewHolder(listItem);
        return viewHolder;
    }
...
/*
                ...
                view = LayoutInflater.from(mContext).inflate(R.layout.layout_bottom_sheet, null);
