...
public class OrderHistoryitemListAdapter extends RecyclerView.Adapter<OrderHistoryitemListAdapter.ViewHolder> {

    private Context mContext;


    private order_details_list_show.item[] orderhistory;

    // RecyclerView recyclerView;
    public OrderHistoryitemListAdapter(Context mContext, List<order_details_list_show.item> orderhistory) {


        this.orderhistory = orderhistory.toArray(new order_details_list_show.item[0]);
    ...
    @Override
    public OrderHistoryitemListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.raw_orderdetails_sublist, parent, false);
        OrderHistoryitemListAdapter.ViewHolder viewHolder = new OrderHistoryitemListAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(OrderHistoryitemListAdapter.ViewHolder holder, int position) {
        final order_details_list_show.item myorderhistory = orderhistory[position];

        List<order_details_list_show.item.addonlist> addondetailslist = orderhistory[position].getAddon();
